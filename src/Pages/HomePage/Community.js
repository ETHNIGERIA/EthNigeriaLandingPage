    ...
    return (
        ...
        <div className="flex flex-col md:flex-row space-x-[3rem] mb-8 items-center text-center p-5">
          ...
          <div className="flex flex-col w-[18rem] items-center">
            ...
            <button className="bg-primary-800 w-[15rem] px-3 py-3 mt-4 text-sm font-medium tracking-wide text-[#fff] transition-colors duration-300 transform rounded-md hover:bg-blue-900 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">Join </button>
          </div>
        </div>
        ...
        <div className="flex flex-col-reverse md:flex-row space-x-[3rem] my-8 items-center text-center">
          <div className="flex flex-col w-[18rem] items-center">
            ...
            {/* <p className="mb-8">consectetur adipiscing elit duis tristique sollicitudin nibh sit amet</p> */}
            <button className="bg-[#0178D4] w-[15rem] px-3 py-3 mt-4 text-sm font-medium tracking-wide text-[#fff] transition-colors duration-300 transform rounded-md hover:bg-blue-900 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">Join </button>
          </div>
          <div>
