                                ...
                                <div className="flex justify-around">
                                    ...
                                    <div className="text-[#fff] font-Inter">
                                        ...
                                        <div className="flex mt-4 -mx-1.5 ">
                                            ...
                                            <a className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="https://twitter.com/EthereumNigeria?s=20&t=fwEmmip83YHxMouYQLSYtA">
